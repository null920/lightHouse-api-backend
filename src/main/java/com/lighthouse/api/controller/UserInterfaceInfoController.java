...
import com.lighthouse.api.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.lighthouse.api.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.lighthouse.api.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
     ...
     * 创建(仅管理员)
     *
     * @param userInterfaceInfoAddRequest 创建接口请求封装类
     ...
     * 更新(仅管理员)
     *
     * @param userInterfaceInfoUpdateRequest 更新接口请求封装类
     * @param request                        http请求
     * @return 是否更新成功
     */
    @PostMapping("/update")
